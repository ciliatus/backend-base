...
use App\MyProject\Api\Exceptions\MissingRequestFieldException;
use App\MyProject\Api\Exceptions\UnhandleableRelationshipException;
use App\MyProject\Api\Http\Controllers\Actions\DestroyAction;
use App\MyProject\Api\Http\Controllers\Actions\StoreAction;
use App\MyProject\Api\Http\Controllers\Actions\UpdateAction;
use App\MyProject\Api\Http\Requests\Request;
use App\MyProject\Common\Enum\HttpStatusCodeEnum;
...
class Controller extends \App\Http\Controllers\Controller
{
    ...
    protected function getModelName(): string
    {
        ...
        return '\\App\\MyProject\\' . $this->package . '\\Models\\' . $class_name;
    }
    ...
    {
        preg_match(
            "/MyProject\\\([A-Za-z]+)\\\Http\\\Controllers\\\([A-Za-z]+)Controller@([A-Za-z_\-]+)/",
